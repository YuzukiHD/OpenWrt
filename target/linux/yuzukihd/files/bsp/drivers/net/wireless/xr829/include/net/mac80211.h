 ...
 */
struct ieee80211_vif *xrmac_wdev_to_ieee80211_vif(struct wireless_dev *wdev);
 ...
 * or AP_VLAN interfaces.)
 */
struct wireless_dev *mac80211_vif_to_wdev(struct ieee80211_vif *vif);
 ...
 */
void mac80211_free_txskb(struct ieee80211_hw *hw, struct sk_buff *skb);
...
struct ieee80211_ops {
	...
	u64 (*prepare_multicast)(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
				 struct netdev_hw_addr_list *mc_list);
	void (*configure_filter)(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
	...
	void (*abort_pmsr)(struct ieee80211_hw *hw, struct ieee80211_vif *vif,
			   struct cfg80211_pmsr_request *request);
	int (*change_mac)(struct ieee80211_hw *hw, struct ieee80211_vif *vif, struct sockaddr *sa);
};
...
struct ieee80211_hw *mac80211_alloc_hw(size_t priv_data_len,
					const struct ieee80211_ops *ops)
{
	return mac80211_alloc_hw_nm(priv_data_len, ops, NULL);
}
...
const char *__mac80211_get_tx_led_name(struct ieee80211_hw *hw);
const char *__mac80211_get_rx_led_name(struct ieee80211_hw *hw);
const char *__mac80211_get_assoc_led_name(struct ieee80211_hw *hw);
const char *__mac80211_get_radio_led_name(struct ieee80211_hw *hw);
const char *
__mac80211_create_tpt_led_trigger(struct ieee80211_hw *hw,
				   unsigned int flags,
 ...
 */
void mac80211_rx_napi(struct ieee80211_hw *hw, struct ieee80211_sta *sta,
...
{
	mac80211_rx_napi(hw, NULL, skb, NULL);
}
 ...
 * be serialized.
 */
void mac80211_sta_pspoll(struct ieee80211_sta *sta);
 ...
 * checks.
 */
void mac80211_sta_uapsd_trigger(struct ieee80211_sta *sta, u8 tid);
 ...
 */
void mac80211_get_tx_rates(struct ieee80211_vif *vif,
			    struct ieee80211_sta *sta,
			    struct sk_buff *skb,
 ...
 */
void mac80211_tx_rate_update(struct ieee80211_hw *hw,
 ...
 */
void mac80211_tx_status_ext(struct ieee80211_hw *hw,
					     ...
					     struct ieee80211_tx_info *info)
{
	...
	mac80211_tx_status_ext(hw, &status);
}
 ...
 */
struct sk_buff *
mac80211_beacon_get_template(struct ieee80211_hw *hw,
			      struct ieee80211_vif *vif,
 ...
 */
u8 mac80211_csa_update_counter(struct ieee80211_vif *vif);
 ...
 */
void mac80211_csa_set_counter(struct ieee80211_vif *vif, u8 counter);
 ...
 */
void mac80211_csa_finish(struct ieee80211_vif *vif);
 ...
 */
bool mac80211_csa_is_complete(struct ieee80211_vif *vif);
...
struct sk_buff *mac80211_proberesp_ext_get(struct ieee80211_hw *hw,
					struct ieee80211_vif *vif);
...
struct sk_buff *mac80211_probereq_data_get(struct ieee80211_hw *hw,
					  struct ieee80211_vif *vif,
					  const u8 *ssid, size_t ssid_len,
 ...
 */
u8 *mac80211_tkip_add_iv(u8 *pos, struct ieee80211_key_conf *keyconf, u64 pn);
 ...
 * can be done concurrently.
 */
void mac80211_set_key_rx_seq(struct ieee80211_key_conf *keyconf,
			      int tid, struct ieee80211_key_seq *seq);
 ...
 */
void mac80211_remove_key(struct ieee80211_key_conf *keyconf);
 ...
 */
struct ieee80211_key_conf *
mac80211_gtk_rekey_add(struct ieee80211_vif *vif,
 ...
 */
void mac80211_iterate_interfaces(struct ieee80211_hw *hw, u32 iter_flags,
...
ieee80211_iterate_active_interfaces(struct ieee80211_hw *hw, u32 iter_flags,
				    ...
				    void *data)
{
	mac80211_iterate_interfaces(hw,
 ...
 * @data: first argument of the iterator function
 */
void mac80211_iterate_active_interfaces_rtnl(struct ieee80211_hw *hw,
					      u32 iter_flags,
					      void (*iterator)(void *data,
						u8 *mac,
						struct ieee80211_vif *vif),
 ...
 * @data: first argument of the iterator function
 */
void mac80211_iterate_stations_atomic(struct ieee80211_hw *hw,
				       void (*iterator)(void *data,
						struct ieee80211_sta *sta),
				       void *data);
/**
 ...
 */
void mac80211_sta_eosp(struct ieee80211_sta *pubsta);
 ...
 */
void mac80211_send_eosp_nullfunc(struct ieee80211_sta *pubsta, int tid);
 ...
 */
void mac80211_sta_register_airtime(struct ieee80211_sta *pubsta, u8 tid,
 ...
 */
void mac80211_iter_keys_rcu(struct ieee80211_hw *hw,
			     struct ieee80211_vif *vif,
			     void (*iter)(struct ieee80211_hw *hw,
					  struct ieee80211_vif *vif,
					  struct ieee80211_sta *sta,
 ...
 * or not.
 */
void mac80211_iter_chan_contexts_atomic(
 ...
 * @gfp: context flags
 */
void mac80211_cqm_beacon_loss_notify(struct ieee80211_vif *vif, gfp_t gfp);
 ...
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 */
void mac80211_radar_detected(struct ieee80211_hw *hw);
 ...
 */
void mac80211_mark_rx_ba_filtered_frames(struct ieee80211_sta *pubsta, u8 tid,
 ...
 * @tid: the rx tid
 */
void mac80211_manage_rx_ba_offl(struct ieee80211_vif *vif, const u8 *addr,
				 unsigned int tid);
						      ...
						      const u8 *addr, u16 tid)
{
	if (WARN_ON(tid >= IEEE80211_NUM_TIDS))
		return;
	mac80211_manage_rx_ba_offl(vif, addr, tid);
}
						     ...
						     const u8 *addr, u16 tid)
{
	if (WARN_ON(tid >= IEEE80211_NUM_TIDS))
		return;
	mac80211_manage_rx_ba_offl(vif, addr, tid + IEEE80211_NUM_TIDS);
}
 ...
 * @tid: the rx tid
 */
void mac80211_rx_ba_timer_expired(struct ieee80211_vif *vif,
 ...
 */
int xrmac_rate_control_set_rates(struct ieee80211_hw *hw,
			   struct ieee80211_sta *pubsta,
			   struct ieee80211_sta_rates *rates);

int mac80211_rate_control_register(const struct rate_control_ops *ops);
void mac80211_rate_control_unregister(const struct rate_control_ops *ops);
 ...
 */
void mac80211_update_mu_groups(struct ieee80211_vif *vif,
 ...
 * applicable.
 */
int mac80211_ave_rssi(struct ieee80211_vif *vif);
 ...
 */
void mac80211_report_wowlan_wakeup(struct ieee80211_vif *vif,
 ...
 */
bool mac80211_tx_prepare_skb(struct ieee80211_hw *hw,
 ...
 */
int mac80211_parse_p2p_noa(const struct ieee80211_p2p_noa_attr *attr,
 ...
 * @tsf: current TSF timestamp
 */
void mac80211_update_p2p_noa(struct ieee80211_noa_data *data, u32 tsf);
 ...
 */
void mac80211_tdls_oper_request(struct ieee80211_vif *vif, const u8 *peer,
 ...
 */
int mac80211_reserve_tid(struct ieee80211_sta *sta, u8 tid);
 ...
 */
void mac80211_unreserve_tid(struct ieee80211_sta *sta, u8 tid);
 ...
 */
struct sk_buff *mac80211_tx_dequeue(struct ieee80211_hw *hw,
				     struct ieee80211_txq *txq);
						      ...
						      struct ieee80211_txq *txq)
{
	...
	local_bh_disable();
	skb = mac80211_tx_dequeue(hw, txq);
	local_bh_enable();
 ...
 */
struct ieee80211_txq *mac80211_next_txq(struct ieee80211_hw *hw, u8 ac);
 ...
 */
void mac80211_txq_schedule_start(struct ieee80211_hw *hw, u8 ac);
...
void __mac80211_schedule_txq(struct ieee80211_hw *hw,
...
{
	__mac80211_schedule_txq(hw, txq, true);
}
...
ieee80211_return_txq(struct ieee80211_hw *hw, struct ieee80211_txq *txq,
		     bool force)
{
	__mac80211_schedule_txq(hw, txq, force);
}
 ...
 * @txq: pointer obtained from station or virtual interface
 */
bool mac80211_txq_may_transmit(struct ieee80211_hw *hw,
				struct ieee80211_txq *txq);
 ...
 */
void mac80211_txq_get_depth(struct ieee80211_txq *txq,
 ...
 * @gfp: allocation flags
 */
void mac80211_nan_func_terminated(struct ieee80211_vif *vif,
				   u8 inst_id,
 ...
 * @gfp: allocation flags
 */
void mac80211_nan_func_match(struct ieee80211_vif *vif,
			      struct cfg80211_nan_match_params *match,
			      gfp_t gfp);


/*int mac80211_set_rts_thresholds(struct ieee80211_hw *hw, u32 value);*/
